<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\UPUPW\UPUPW_NP7.0\htdocs\yimi\public/../application/admin\view\cate\topcate.html";i:1503990470;}*/ ?>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('Cate/index'); ?>">顶级分类管理</a>
                    </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('Cate/addTopCate'); ?>" method="post">
