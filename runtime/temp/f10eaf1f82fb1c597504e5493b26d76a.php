<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\UPUPW\UPUPW_NP7.0\htdocs\yimi\public/../application/admin\view\goods\add.html";i:1504063370;}*/ ?>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('Goods/add'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="market_price" placeholder="" name="market_price" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="sell_price" placeholder=""required="" name="sell_price" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="point" placeholder=""required="" name="point" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="store" placeholder=""required="" name="store" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
